...
//    private static final long serialVersionUID = 1L;
    ...
    public EnemyTank(int px, int py, TankWar05 myPanel) {
        super(px, py, Direction.DOWN, myPanel);
    }

    public EnemyTank(int px, int py, int speed, TankWar05 myPanel) {
        super(px, py, Direction.DOWN, speed, myPanel);
    }

    public EnemyTank(int px, int py, Direction tankDirection, int speed, TankWar05 myPanel) {
