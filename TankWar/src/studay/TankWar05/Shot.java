...
public class Shot extends Bullrt implements Runnable {
    ...
    public Shot(int x, int y, Direction direction, int speed, int type, TankWar05 panel) {
    ...
    public boolean moveToBoundary() {
        if (x > MyPanel.GameWidthframe - speed || x < 0 || y < 0 || y > MyPanel.heightframe) {
            return true;
        }
        return false;
    }
